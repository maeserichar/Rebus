...
namespace Rebus.IdempotentSagas
{
    ...
    public static class IdempotentSagaConfigurationExtensions
    {
        ...
        private static void TransportMessageEvent(IEnumerable<string> destinations, Message message, bool published)
        {
        ...
        {
            events.TransportMessageSent += TransportMessageEvent;
